...
urlpatterns = [
    ...
    # Manga APIs
    path(
        "manga-chapters/<int:manga_id>/",
        views.manga_chapters_api,
        name="manga_chapters_api",
    ),
    ...
    path(
        ...
        views.update_audio_position,
        name="update_audio_position",
    ),
    # Auth
    ...
    path(
        "search-suggestions/", views.book_search_suggestions, name="search_suggestions"
    ),
